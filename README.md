...
Я тестировщик уровня junior+, ищу удаленную работу.
<br><br>
## Обо мне
Я тестировщик ручного и автоматизированного тестирования (Pytest, Selenium, Gauge). Имею богатый опыт тестирования различных веб-приложений. Активно углубляю свои знания инструментов тестирования. Прохожу различные онлайн-курсы по смежным с тестированием дисциплинам. Участвую в краудфандинговых и Open Source проектах тестирования. 
<br><br>
## Связаться со мной
