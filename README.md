...
|6|[Тестирование основного функционала портала FUN&SUN](https://ilsinyakov.notion.site/9dad850599664ba2bf80c44aa4db318c)|Учебный проект. Проведено тестирвоание: функциональное, UI/UX, производительности, API, кросс-браузерное|<ul><li>Postman - API</li><li>JMeter - тестирование производительности</li><li>Qase - тест-кейсы</li></ul>